...
public class ChapaMetalica3 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ChapaMetalica3.inicializar(matrizPrincipal);
        ChapaMetalica3.inicializar(matrizAuxiliar);
        ChapaMetalica3.temperaturasConstantes(matrizPrincipal);
        ChapaMetalica3.temperaturasConstantes(matrizAuxiliar);
        ...
        while (error > maximoErro && iteracao < maximoIteracao ) {
            ...
            ChapaMetalica3.propagacao(matrizPrincipal, matrizAuxiliar);
            error = ChapaMetalica3.erro(matrizPrincipal, matrizAuxiliar);
            ChapaMetalica3.salvaMatrizAntiga(matrizPrincipal, matrizAuxiliar);
